    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            float4 frag(v2f i) : SV_Target
            {
                ...
                //锥化
                float coneMask = step(i.layerH01, pow(height, _ConePow));

                //高度-透明度衰减
                float heightOpacityAtten = pow(saturate(1.001 - i.layerH01), _OpacityPow);
