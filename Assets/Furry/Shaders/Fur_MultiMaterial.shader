Shader "Effect/Fur_MultiMaterial"
{
    Properties
    {
        [Header(Texture)]
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            v2f vert(a2v i)
            {
                ...
                posWS += o.nDirWS * _Height01 * _Thick;
            ...
            float4 frag(v2f i) : SV_Target
            {
                ...
                //锥化
                float coneMask = step(_Height01, pow(height, _ConePow));

                //高度-透明度衰减
                float heightOpacityAtten = pow(saturate(1.001 - _Height01), _OpacityPow);
